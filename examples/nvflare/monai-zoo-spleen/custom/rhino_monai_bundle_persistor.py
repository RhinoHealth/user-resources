...
class RhinoMonaiBundlePersistor(PTFileModelPersistor):
    def __init__(
        self,
        bundle_root: str,
    ...
    def _parse_config(self, fl_ctx: FLContext):
        ...
        # self.bundle_root = os.path.join('/home/localuser/', self.bundle_root)
        shutil.copytree('/home/localuser/config', app_root+'/config', dirs_exist_ok=True)
        print('global_model_file_name')
        print(self.global_model_file_name)
