# NVIDIA FLARE Example - XGBoost Sequential SAG
...
* Determine SequentialScatterAndGather workflow that enables running multiple FL clients on the same machine, executing the client-side training one at a time, in order to share the local compute resources.
