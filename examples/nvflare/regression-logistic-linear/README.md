# NVIDIA FLARE Example - Logistic and Linear Regression

## Description
This example uses NVIDIA FLARE v2.3 to fit logistic and linear regression models using Rhino's Federated Computing Platform (FCP)
