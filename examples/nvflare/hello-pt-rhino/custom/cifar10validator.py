...
class Cifar10Validator(Executor):
    ...
    def __init__(self, validate_task_name=AppConstants.TASK_VALIDATION):
        ...
        self.cohort_validation =pd.read_csv('/home/ubuntu/nvflare2/NVFlare/examples/hello-pt-rhino/data/test/cohort_data_test.csv') # TODO what is the correct cohort (more than 1)
        # Setup the model
        ...
        self.test_data = torchvision.datasets.ImageFolder(root='/home/ubuntu/nvflare2/NVFlare/examples/hello-pt-rhino/data/train/', transform=transforms)
        # self.test_data = CIFAR10(root='~/rhino_data/input/', train=False, transform=transforms)
