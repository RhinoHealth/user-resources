# NVIDIA FLARE Example - MIMIC CXR with NVIDIA FLARE v2.4

## Description
This example contains files to train a pneumonia detection model from Chest XRays using Rhino's Federated Computing Platform (FCP) and NVIDIA FLARE v2.4.
